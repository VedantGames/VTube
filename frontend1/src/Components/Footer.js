    ...
    <div className='fixed w-full bottom-0 right-0 bg-primary lg:hidden block z-50'>
      ...
      <div className='w-full'>
        <div className='flex justify-between px-6'>
          ...
          <Link to={'/trendings'} onClick={() => setCurrentSlide('trending')}>
            {currentSlide !== 'trending' ? (
          ...
          <Link to={'/account'} onClick={() => setCurrentSlide('profile')}>
          ...
          <Link to={'/subscriptions'} onClick={() => setCurrentSlide('subscription')}>
            {currentSlide !== 'subscription' ? (
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-7">
          ...
          <Link to={'/you'} onClick={() => setCurrentSlide('upload')}>
            {currentSlide !== 'upload' ? (
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-7">
