  ...
  return (
    <div className={'px-2 pt-2 h-full max-h-[93.3vh] w-60 min-w-60 overflow-x-hidden overflow-y-scroll hidden ' + (showSidePanel && 'lg:block')}>
      ...
      <div className='my-2'>
        ...
        <Link className={'flex h-10 py-2.5 bg-zinc-800 hover:bg-opacity-100 w-52 rounded-xl ' + getOpacity('watchLater')} onClick={() => selectSlide('watchLater')}>
          <div className='ml-4 mr-6 mb-1'>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
              <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
            </svg>
        ...
        <Link className={'flex h-10 py-2.5 bg-zinc-800 hover:bg-opacity-100 w-52 rounded-xl ' + getOpacity('likedVideos')} onClick={() => selectSlide('likedVideos')}>
          <div className='ml-4 mr-6 mb-1'>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
