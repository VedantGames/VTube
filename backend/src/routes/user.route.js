...
const { registerUser, loginUser, uploadProfileImage, uploadProfileBanner, getUserHistory, getChannel, getSubscriptions, getYouHistory } = require('../controllers/User.controller');
